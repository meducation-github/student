...
export default function Header() {
  ...
  return (
    <div>
      <nav className="bg-white max-w-7xl mx-auto border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
        <div className="flex flex-wrap justify-between items-center">
          ...
          <div className="flex items-center lg:order-2">
            ...
            <div className="relative">
              ...
              {isOpen && (
                <div className="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-lg dark:bg-gray-700 z-50">
            ...
            <div className="relative">
              <button
                ...
                className="flex mx-3 cursor-pointer text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
                id="user-menu-button"
                aria-expanded="false"
              ...
              {profile && (
                <div
                  className="z-50 text-left absolute right-0 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
                  id="dropdown"
                >
